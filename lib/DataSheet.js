...
import { TAB_KEY, ENTER_KEY, DELETE_KEY, ESCAPE_KEY, BACKSPACE_KEY, LEFT_KEY, UP_KEY, DOWN_KEY, RIGHT_KEY } from './keys';
...
var DataSheet = function (_PureComponent) {
  ...
  _createClass(DataSheet, [{
    ...
    value: function handleKey(e) {
      ...
      var deleteKeysPressed = keyCode === DELETE_KEY || keyCode === BACKSPACE_KEY;
      var enterKeyPressed = keyCode === ENTER_KEY;
          ...
          data.map(function (row, i) {
            return React.createElement(
              ...
              row.map(function (cell, j) {
                ...
                return React.createElement(DataCell, _extends({
